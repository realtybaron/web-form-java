...
public abstract class AbstractFormAction extends AbstractAction {
  ...
  protected Object getFormObject(HttpServletRequest req) throws Exception {
    ...
    if (command == newbie && this.bindOnNewForm(req)) {
      ErrorPacket errors = new ErrorPacket();
  ...
  protected void bindFormObject(HttpServletRequest request, Object o, ErrorPacket errors) throws Exception {
   ...
   */
  protected void validateFormObject(HttpServletRequest request, Object o, ErrorPacket errors) throws Exception {
    Form form = this.getClass().getAnnotation(Form.class);
  ...
  */
   ...
   */
  protected void onBindOnNewForm(HttpServletRequest request, Object o, ErrorPacket errors) throws Exception {
    // noop
  }
   ...
   */
  protected boolean onBind(HttpServletRequest request, HttpServletResponse response, Object o, ErrorPacket errors) throws Exception {
    return false;
  }
   ...
   * @throws Exception bad stuff
   */
  protected void onBindAndValidate(HttpServletRequest request, Object o, ErrorPacket errors) throws Exception {
    // noop
  }
   ...
   * @throws Exception bad stuff
   */
  protected abstract void showForm(HttpServletRequest request, HttpServletResponse response, Object o, ErrorPacket errors) throws Exception;
   ...
   */
  protected abstract void handleFormSubmission(HttpServletRequest request, HttpServletResponse response, Object o, ErrorPacket errors) throws IOException, ServletException;
